...
public class Main2_과제_진행하기 {
	...
	public static void main(String args[]) {
		String[][] sample = new String[][] { { "korean", "11:40", "30" },
				{ "english", "12:10", "20" },
				{ "math", "12:30", "40" } };
			...
			if (gap > 0) { // 다음 시작시간을 넘어감, stack에 넣어야함
				...
				while (leftTime > 0 && !delayed.isEmpty()) {
					...
					if (gap2 >= 0) {// 남은 시간 안에 delayed 과제 끝낸 경우
						/**
						 * 여기! gap2>=0이 아니라 gap2>0이라 써서 틀린거였음
						 * gap2=0인 것 또한 남은 과제 하나를 완료한거임
						 */
						...
						delayed.add(temp);
						break; // left time 갱신 필요 없음, 물론 필수 아님
					}
					leftTime = gap2;
				}
			}
